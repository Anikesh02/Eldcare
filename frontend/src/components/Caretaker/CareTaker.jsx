      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="rounded-l-lg lg:pl-16 py-10">
          <h3 className='text-headingColor text-[22px] leading-9 font-bold mb-10'>
            Application for <span className='text-primaryColor'>Care Taker</span>
          </h3>
          ...
          <form onSubmit={submitHandler}>
            ...
            <div className="mb-5">
              <input type="aadhar" placeholder='Enter your Aadhaar Card Number' name='aadhaar' value={formData.password} onChange={handleInputChange} className='w-full pr-4 py-3 border-b bprder-solid border-[#0066ff61] focus:outline-none focus:border-b-primaryColor text-[16px] leading-7 text-headingColor placeholder:text-textColor cursor-pointer' required />
            </div>
            ...
            <div className="mb-5 flex items-center justify-between">
              <label className='text-headingColor font-bold text-[16px] leading-7'> Are you a:
                <select name="role" value={formData.role} onChange={handleInputChange} className='text-textColor font-semibold text-[15px] leading-7 px-4 py-3 focus:outline-none' required>
                  <option value="patient">Professional</option>
                  <option value="doctor">Non-professional</option>
                </select>
              </label>
            ...
            <div className="mb-5">
              <input type="aadhar" placeholder='Enter your resume link' name='aadhaar' value={formData.password} onChange={handleInputChange} className='w-full pr-4 py-3 border-b bprder-solid border-[#0066ff61] focus:outline-none focus:border-b-primaryColor text-[16px] leading-7 text-headingColor placeholder:text-textColor cursor-pointer' />
            </div>
            ...
            <div className="mt-7">
              <button type='submit' className="w-full bg-primaryColor text-white text-[18px] leading-[30px] rounded-lg px-4 py-3 hover:bg-[#5b5be7]"><Loader onClick={handleButtonClick}isLoading={isLoading} buttonText="Submit"/></button>
