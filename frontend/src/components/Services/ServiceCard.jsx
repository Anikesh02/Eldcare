    ...
    return (
        <div className='py-[30px] px-3 lg:px-5'>
            ...
            <div className="flex items-center justify-center mt-[30px] ">
                <Link to='/doctors' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] flex items-center justify-center group hover:bg-primaryColor hover:border-none mr-[320px]'>
